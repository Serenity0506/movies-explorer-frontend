  ...
  return (
    <section id='portfolio' className={styles.portfolio__container}>
      ...
      <div className={styles.portfolio__container_grid}>
        <div className={styles.portfolio__img}>
          <img
            alt='LGayduk'
            src={photo}
            className={styles.portfolio__img_pic}
          ></img>
        </div>
        <div className={styles.portfolio__info}>
          <h5 className={styles.portfolio__info_title}>Виталий</h5>
          <h5 className={styles.portfolio__info_subtitle}>
            Фронтенд-разработчик, 30 лет
          </h5>
          <p className={styles.portfolio__info_text}>
          ...
          <a
            href='https://github.com/Serenity0506'
            target='blanc'
      ...
      <div className={styles.portfolio__container_link}>
        <a
          href='https://github.com/Serenity0506/russian-travel'
          target='blanc'
          className={styles.portfolio__link_big}
        >
          Статичный сайт
      ...
      <div className={styles.portfolio__container_link}>
        <a
          href='https://github.com/Serenity0506/react-mesto-auth'
          target='blanc'
          className={styles.portfolio__link_big}
        >
          Адаптивный сайт
      ...
      <div className={styles.portfolio__container_link}>
        <a
          href='https://github.com/Serenity0506/e-shop'
          target='blanc'
          className={styles.portfolio__link_big}
        >
